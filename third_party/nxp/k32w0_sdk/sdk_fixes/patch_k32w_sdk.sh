...
convert_to_dos "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/OtaSupport/Source/OtaUtils.c
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/OtaSupport/Source -p1 <"$SOURCE_DIR/OtaUtils_c.patch"

convert_to_dos "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/OtaSupport/Source/OtaSupport.c
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/OtaSupport/Source -p1 <"$SOURCE_DIR/OtaSupport_c.patch"

convert_to_dos "$NXP_K32W0_SDK_ROOT"/middleware/wireless/bluetooth/host/interface/ble_utils.h
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/middleware/wireless/bluetooth/host/interface -p1 <"$SOURCE_DIR/ble_utils_h.patch"

convert_to_dos "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/Flash/External/Source/Eeprom_MX25R8035F.c
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/Flash/External/Source -p1 <"$SOURCE_DIR/Eeprom_MX25R8035F_c.patch"

convert_to_dos "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/MemManager/Interface/MemManager.h
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/MemManager/Interface -p1 <"$SOURCE_DIR/MemManager_h.patch"
...
cp patch_for_K32W061_SDK_2_6_4/controller_config.c    "$NXP_K32W0_SDK_ROOT"/middleware/wireless/ble_controller/config/
cp patch_for_K32W061_SDK_2_6_4/controller_interface.h "$NXP_K32W0_SDK_ROOT"/middleware/wireless/ble_controller/interface/
cp patch_for_K32W061_SDK_2_6_4/lib_ble_controller.a   "$NXP_K32W0_SDK_ROOT"/middleware/wireless/ble_controller/lib/
cp patch_for_K32W061_SDK_2_6_4/libPDM_extFlash.a      "$NXP_K32W0_SDK_ROOT"/middleware/wireless/framework/PDM/Library/
